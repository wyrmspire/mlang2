...
class SimulationSession:
    ...
    def step_once(self) -> Optional[List[SimEvent]]:
        ...
        """
        if self.stepper.is_done() or not self.is_running or self.is_paused:
            return None
        ...
        current_price = float(step.current_bar['close'])
    ...
    def play(self) -> Iterator[SimEvent]:
        ...
        while not self.stepper.is_done() and self.is_running:
